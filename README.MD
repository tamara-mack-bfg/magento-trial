...
**[Clone the following from GIT](https://github.com/mike61988/magento2-dk/) to your working directory. Then, create a folder 
called _instances_ within that directory.**
