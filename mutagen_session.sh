...
howTo() {
    ...
    echo ""
    echo " +---------------------------------------------------------------------+"
    echo " | To resume mutagen session you need to use 'resume' command, example: |"
    echo " +---------------------------------------------------------------------+"
    echo " +-----------UNIX/MAC-----------+"
    ...
    echo ""
    echo " +------------------------------------------------------------------------+"
    echo " | To terminate mutagen session you need to use 'terminate' command, example: |"
    echo " +------------------------------------------------------------------------+"
    echo " +-------------UNIX/MAC------------+"
    ...
    echo ""
    echo " +--------------------------------------------------------------------+"
    echo " | To list mutagen sessions you need to use 'list' command, example: |"
    echo " +--------------------------------------------------------------------+"
    echo " +----------UNIX/MAC----------+"
